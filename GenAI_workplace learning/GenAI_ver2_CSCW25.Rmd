...
b_method2 <- ggplot(df_method, aes(x = reorder(method, freq), y = freq, fill = method)) +
  ...
  coord_flip()
b_method2
ggsave(b_method2, filename="method_rev.jpg", device="jpg", width = 11, height = 6, dpi = 1200)
```
...
b_source2 <- ggplot(df_source, aes(x = reorder(source,freq), y = freq, fill = source)) +
  ...
  coord_flip()
b_source2
ggsave(b_source2, filename="source_rev.jpg", device="jpg", width = 13, height = 6, dpi = 1200)
```
...
b_impact2 <- ggplot(df_impact, aes(x = reorder(impact, freq), y = freq, fill = impact)) +
  ...
  coord_flip()
b_impact2
ggsave(b_impact2, filename="impact_rev.jpg", device="jpg", width = 11, height = 6, dpi = 1200)
...
total_factor <- n_distinct(stats_factor$ID)
